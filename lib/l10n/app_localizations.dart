...
abstract class AppLocalizations {
  ...
  /// No description provided for @buycommission.
  ///
  /// In en, this message translates to:
  /// **'Buy Commission'**
  String get buycommission;

  /// No description provided for @sellcommission.
  ///
  /// In en, this message translates to:
  /// **'Sell Commission'**
  String get sellcommission;
}
