...
class Companyregistration extends ConsumerStatefulWidget {
  const Companyregistration({super.key, required this.userType});
                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          if (formKey.currentState!.validate()) {
                            ...
                            ref
                                .watch(
                                  registerUserProvider(
                                    ...
                                    moaAoa: ref.watch(moaAoaImageProvider),
                                    boardResolution: ref.watch(
                                      boardResolutionImage,
                                    ),
                                    directorProof: ref.watch(
                                      directorProofImage,
                                    ),
                            ...
                            //               directorProof: ref.watch(directorProofImage),
                            ...
                            if (ref.watch(personalImageProvider) == null) {
                              context.errorToast('Please Personal image');
                            } else if (ref.watch(panImageProvider) == null) {
                              context.errorToast('Please select Pan Image');
                            } else if (ref.watch(authorisedImageProvider) ==
                                null) {
                              context.errorToast(
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            label: Text("Enter Company Address"),
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(10),
            ),
            border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)),
      ...
      children: [
        ...
        ColumnSuper(
          children: [
            ...
            //       label:  Text("Enter Company Email"),
            //       enabledBorder: OutlineInputBorder(
            //           borderRadius: BorderRadius.circular(10)),
            //       border: OutlineInputBorder(
            //           borderRadius: BorderRadius.circular(10)),
        ...
        //       label:  Text("Enter Company PAN Number"),
        //       enabledBorder:
        //           OutlineInputBorder(borderRadius: BorderRadius.circular(10)),
        //       border:
        //           OutlineInputBorder(borderRadius: BorderRadius.circular(10)),
        ...
        SizedBox(
          ...
          child: InkWell(
            onTap: () async {
              showImageSourceDialog(context, (value) {
                ref.watch(moaAoaImageProvider.notifier).state = File(
                  value.path,
                );
              });
            },
            child: dottedBorder.DottedBorder(
              ...
              child: Padding(
                ...
                child: Center(
                  child:
                      ref.watch(moaAoaImageProvider) != null
                          ? Stack(
                            children: [
                              Image.file(
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            label: Text("Enter No of Directors"),
            enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(10),
            ),
            border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)),
