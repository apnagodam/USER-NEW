      ...
      body: SafeArea(
        child: ref
            ...
            .when(
              ...
              error:
                  (e, s) => Center(
                    child: Text(AppLocalizations.of(context)!.errorE2),
                  ),
              loading:
                  () => SizedBox(
                    height: Get.height,
