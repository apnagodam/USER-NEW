...
//
//     final summaryFilterRequestModel = summaryFilterRequestModelFromMap(jsonString);

import 'dart:convert';

SummaryFilterRequestModel summaryFilterRequestModelFromMap(String str) => SummaryFilterRequestModel.fromMap(json.decode(str));

String summaryFilterRequestModelToMap(SummaryFilterRequestModel data) => json.encode(data.toMap());
