...
//
//     final homeResponseModel = homeResponseModelFromMap(jsonString);

import 'dart:convert';

HomeResponseModel homeResponseModelFromMap(String str) => HomeResponseModel.fromMap(json.decode(str));

String homeResponseModelToMap(HomeResponseModel data) => json.encode(data.toMap());

class HomeResponseModel {
  List<HomeResponseModelTodaysPrice>? todaysPrice;
  ...
  factory HomeResponseModel.fromMap(Map<String, dynamic> json) => HomeResponseModel(
    todaysPrice: json["todays_price"] == null ? [] : List<HomeResponseModelTodaysPrice>.from(json["todays_price"]!.map((x) => HomeResponseModelTodaysPrice.fromMap(x))),
...
class HomeResponseModelTodaysPrice {
  dynamic id;
  dynamic wspId;
  ...
  factory HomeResponseModelTodaysPrice.fromMap(Map<String, dynamic> json) => HomeResponseModelTodaysPrice(
    id: json["id"],
    wspId: json["wsp_id"],
