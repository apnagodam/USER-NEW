...
class F2fdealscreen extends ConsumerStatefulWidget {
  final commodityid;
  final commodityName;
  const F2fdealscreen({
    super.key,
  ...
  @override
  ConsumerState<F2fdealscreen> createState() => _F2fdealscreenState();
}

class _F2fdealscreenState extends ConsumerState<F2fdealscreen> {
  var result;
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                ...
                                Text(cont.face2facecal['wallet_balance']),
                              ],
                            ),
                            Divider(thickness: 1),
                            Text.rich(
                              TextSpan(
                                ...
                                children: [
                                  TextSpan(text: cont.face2facecal['seller']),
                                ],
                              ),
                            ),
                            SizedBox(height: 5),
                            Row(
                              ...
                              children: [
                                ...
                                Text(cont.face2facecal['commodity']),
                              ],
                            ),
                            SizedBox(height: 5),
                            Row(
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  cont.face2facecal['mandi_tax_amount']
                                      .toString(),
                                ),
                              ],
                            ),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(cont.face2facecal['ag_commission_amount']),
                              ],
                            ),
                            SizedBox(height: 5),
                            Row(
                              ...
                              children: [
                                ...
                                Text(cont.face2facecal['deal_amount']),
                              ],
                            ),
                            Divider(thickness: 1),
                            SizedBox(height: 5),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(cont.face2facecal['final_amount']),
                              ],
                            ),
                            SizedBox(height: 10),
                            InkWell(
              ...
              data:
                  (userData) => Column(
                    ...
                    children: [
                      ...
                      cont.salected == AppLocalizations.of(context)!.msgDelivery
                          ? Padding(
