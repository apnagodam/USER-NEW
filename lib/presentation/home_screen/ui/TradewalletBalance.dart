...
class Tradewalletbalance extends ConsumerStatefulWidget {
  const Tradewalletbalance({super.key});

  @override
  ConsumerState<Tradewalletbalance> createState() => _TradewalletbalanceState();
}

class _TradewalletbalanceState extends ConsumerState<Tradewalletbalance> {
  ...
  Future<void> _fetchBankDetails() async {
    try {
      final response =
          await ref.read(dioProvider).post('user_api/get_user_bank_details');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ref.watch(userDetailsProvider).when(
            data: (userData) => RefreshIndicator.adaptive(
              child: ListView(
                children: [
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        //         ),
                        customWalletTitle(
                          title: ref.watch(bankDetailsProvider)?['bankArray']
                                  ?['virtubankData']?['BeneficiaryName'] ??
                              "NA",
                          align: Alignment.center,
                        ),
                        Padding(
                            ...
                            children: [
                              ...
                              Text(
                                currencyFormat.format(
                                  userData.userDetails?.tradePower
                                      .toString()
                        ...
                        Padding(
                          ...
                          child: OutlinedButton(
                            ...
                            onPressed: () {
                              Get.to(SbtHoldSummary(walletType: '2'));
                            },
                            child: Row(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    Text(
                                      currencyFormat.format(
                                        userData.userDetails?.tradeHoldPower
                                            .toString()
                                            .convertToDouble(
                                              defaultValue: 0.00,
                                            ),
                            ...
                            children: [
                              ...
                              Text(
                                currencyFormat.format(
                                  num.parse(
                                    ((num.parse(
                                                  "${userData.userDetails?.tradePower ?? "0.0"}",
                                                )) -
                                                (num.parse(
                                                  "${userData.userDetails?.tradeHoldPower ?? "0.0"}",
                                                )))
                                            .toString() ??
                                        "0.0",
                                  ),
                        ...
                        Padding(
                          ...
                          child: Form(
                            ...
                            child: CommonTextField(
                              ...
                              label: AppLocalizations.of(context)!.enterAmuont,
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text(
                                AppLocalizations.of(context)!.msgWithdrawa,
                                style: AppStyle.lblmoneybtn.copyWith(
                                  fontSize: Adaptive.sp(16),
                                ),
                              ),
                            ),
