...
import '../../../localization/app_localizations_extras.dart';
...
class _SbtscreenState extends ConsumerState<Sbtscreen> {
  ...
  var sellPriceProvider = StateProvider<double>((ref) => 0.0);
  ...
  List<Map<String, dynamic>> get tabs => [
        ...
        // {"label": "Guarantor".tr, "index": 1, "icon": Icons.receipt_long},
        // {"label": "Buy Deals".tr, "index": 2, "icon": Icons.receipt_long},
        // {"label": "Sell Deals".tr, "index": 3, "icon": Icons.wallet},
        {
          "label": AppLocalizations.of(context)!.deliveryMarking,
          "index": 4,
  ...
  Widget build(BuildContext context) {
    var commodityProvider = ref.watch(getSbtCommodityProvider);
    return Scaffold(
                  ...
                  child: Material(
                    ...
                    child: TabBar(
                      ...
                      tabs: [
                        ...
                        Tab(
                          child: Text(
                            AppLocalizations.of(context)!.deliveryMarking,
                            textAlign: TextAlign.center,
                          ),
                        ),
                      ],
                                                                        ...
                                                                        ElevarmBottomSheet(
                                                                          ...
                                                                          children: [
                                                                                ...
                                                                                children: [
                                                                                  Expanded(
                                                                                    ...
                                                                                    onPressed: () async {
                                                                                      if (ref.watch(authProvider).value == AuthStatus.loggedIn) {
                                                                                        _buyPrice = double.parse('${dataList[mainIndex].lowerCircuit ?? 0.0}');

                                                                                        ref.watch(buyWeight.notifier).state = 0.0;

                                                                                        buyPriceController.clear();
                                                                                        buyWeightController.text = '0';
                                                                                                                ...
                                                                                                                child: Column(mainAxisSize: MainAxisSize.min, children: [
                                                                                                                  ...
                                                                                                                  Center(
                                                                                                                    child: Padding(
                                                                                                                      ...
                                                                                                                      child: Text.rich(TextSpan(text: AppLocalizations.of(context)!.product, style: TextStyle(fontSize: Adaptive.sp(16), fontWeight: FontWeight.bold), children: [
                                                                                                                        TextSpan(text: " : ${data.data != null ? data.data![mainIndex].commodity : ''} (${data.data != null ? data.data![mainIndex].district : ''})")
                                                                                                                      ])),
                                                                                                                    ),
                                                                                                                  ),
                                                                                                                  SizedBox(
                                                                                                                  ...
                                                                                                                  RowSuper(
                                                                                                                    ...
                                                                                                                    children: [
                                                                                                                      ...
                                                                                                                      //                       .bold))
                                                                                                                      //     ])),
                                                                                                                      Text.rich(TextSpan(text: "Date: ", style: TextStyle(fontSize: Adaptive.sp(16), fontFamily: 'Roboto', fontWeight: FontWeight.bold), children: [
                                                                                                                        TextSpan(text: "${dataList[mainIndex].date}", style: TextStyle(fontSize: Adaptive.sp(16), fontFamily: 'Roboto', color: ColorConstant.maingreen, fontWeight: FontWeight.bold))
                                                                                                                      ]))
                                                                                                                    ],
                                                                                                                  ),
                                                                                                                  Divider(),
                                                                                                                  ...
                                                                                                                  Column(
                                                                                                                    children: [
                                                                                                                      Padding(
                                                                                                                        ...
                                                                                                                        child: Text(AppLocalizations.of(context)!.msgYourprice, style: TextStyle(fontSize: Adaptive.sp(16), fontFamily: 'Roboto', color: ColorConstant.maingreen, fontWeight: FontWeight.bold)),
                                                                                                                      ),
                                                                                                                      Padding(
                                                                                                                        padding: Pad(all: 10),
                                                                                                                        child: SizedBox(
                                                                                                                          ...
                                                                                                                          child: CommonTextField(
                                                                                                                            ...
                                                                                                                            hintText: '0',
                                                                                                                            label: AppLocalizations.of(context)!.enterBuyPrice,
                                                                                                                            onEditComplete: (value) {
                                                                                                                              debouncer.call(() {
                                                                                                                                setState(() {
                                                                                                                                  _buyPrice = double.tryParse(value) ?? 0.0;
                                                                                                                                });
                                                                                                                              });
                                                                                                                            },
                                                                                                                          ),
                                                                                                                      ...
                                                                                                                      Column(
                                                                                                                        children: [
                                                                                                                          Padding(
                                                                                                                            padding: EdgeInsets.only(bottom: 5.0),
                                                                                                                            child: Text(AppLocalizations.of(context)!.msgNetweight, style: TextStyle(fontSize: Adaptive.sp(16), fontFamily: 'Roboto', color: ColorConstant.maingreen, fontWeight: FontWeight.bold)),
                                                                                                                          ),
                                                                                                                          Padding(
                                                                                                                            padding: Pad(all: 10),
                                                                                                                            child: SizedBox(
                                                                                                                              ...
                                                                                                                              child: CommonTextField(
                                                                                                                                ...
                                                                                                                                inputType: TextInputType.numberWithOptions(decimal: true),
                                                                                                                                label: AppLocalizations.of(context)!.enterWeight,
                                                                                                                                hintText: '0.0',
                                                                                                                                onEditComplete: (value) {
                                                                                                                                  ref.watch(buyWeight.notifier).state = double.tryParse(value) ?? 0.0;
                                                                                                                                },
                                                                                                                              ),
                                                                                                                            ),
                                                                                                                          ),
                                                                                                                  ...
                                                                                                                  ref.watch(sbtTermsProvider(userType: "1", productId: "${dataList[mainIndex].productId}")).when(data: (data) => HtmlWidget(data['data'] ?? ""), error: (e, s) => Container(), loading: () => Center(child: CircularProgressIndicator())),
                                                                                                                  Padding(
                                                                                                                    ...
                                                                                                                    child: Row(
                                                                                                                      children: [
                                                                                                                        Expanded(
                                                                                                                          child: ElevatedButton(
                                                                                                                              style: AppStyle.buttonStyle.copyWith(backgroundColor: WidgetStatePropertyAll(Colors.red)),
                                                                                                                              onPressed: () {
                                                                                                                                Get.back();
                                                                                                                              },
                                                                                                                              child: Text(AppLocalizations.of(context)!.msgCencel, style: TextStyle(fontSize: Adaptive.sp(18), fontFamily: 'Roboto', fontWeight: FontWeight.w500, color: Colors.white))),
                                                                                                                        ),
                                                                                                                        SizedBox(
                                                                                                                          width: 20,
                                                                                                                        ),
                                                                                                                        Expanded(
                                                                                                                          child: ElevatedButton(
                                                                                                                            ...
                                                                                                                            onPressed: () async {
                                                                                                                              if (_buyPrice < 1) {
                                                                                                                                context.errorToast('Please input valid buying price');
                                                                                                                              } else {
                                                                                                                                if (ref.watch(buyWeight) > 0.0) {
                                                                                                                                  if (buyKey.currentState!.validate()) {
                                                                                                                                    _handleBuyOption(dataList, mainIndex, bottomsheetContext, ref.watch(buyWeight), _buyPrice);
                                                                                                                                  }
                                                                                                                                } else {
                                                                                                                            ...
                                                                                                                            child: Text(AppLocalizations.of(context)!.msgSubmit, style: TextStyle(fontSize: Adaptive.sp(18), fontFamily: 'Roboto', fontWeight: FontWeight.w500, color: Colors.white)),
                                                                                                                          ),
                                                                                                                        )
                                                                                                                      ],
                                                                                                                    ),
                                                                                    ...
                                                                                    child: Text(
                                                                                      AppLocalizations.of(context)!.msgBuy,
                                                                                      style: TextStyle(color: Colors.white, fontSize: Adaptive.sp(18)),
                                                                                    ),
                                                                                  )),
                                                                                  SizedBox(
                                                                                    width: 15,
                                                                                  ...
                                                                                  Expanded(
                                                                                    ...
                                                                                    onPressed: () async {
                                                                                      ...
                                                                                      ref.watch(sellWeight.notifier).state = 0.0;
                                                                                      if (ref.watch(authProvider).value == AuthStatus.loggedIn) {
                                                                                        showBarModalBottomSheet(
                                                                                            context: context,
                                                                                            backgroundColor: Colors.white,
                                                                                                              ...
                                                                                                              child: Wrap(children: [
                                                                                                                ...
                                                                                                                Center(
                                                                                                                  child: Padding(
                                                                                                                    padding: EdgeInsets.only(bottom: 8.0),
                                                                                                                    child: Text.rich(TextSpan(text: AppLocalizations.of(context)!.product, style: TextStyle(fontSize: Adaptive.sp(16), fontWeight: FontWeight.bold), children: [
                                                                                                                      TextSpan(text: " : ${dataList[mainIndex].commodity} (${dataList[mainIndex].district})")
                                                                                                                    ])),
                                                                                                                  ),
                                                                                                                ),
                                                                                                                SizedBox(
                                                                                                                ...
                                                                                                                RowSuper(
                                                                                                                  ...
                                                                                                                  children: [
                                                                                                                    ...
                                                                                                                    //                       .bold))
                                                                                                                    //     ])),
                                                                                                                    Text.rich(TextSpan(text: AppLocalizations.of(context)!.msgDate, style: TextStyle(fontSize: Adaptive.sp(16), fontWeight: FontWeight.bold), children: [
                                                                                                                      TextSpan(text: "${dataList[mainIndex].date}", style: TextStyle(fontSize: Adaptive.sp(16), fontFamily: 'Roboto', color: ColorConstant.maingreen, fontWeight: FontWeight.bold))
                                                                                                                    ]))
                                                                                                                  ],
                                                                                                                ),
                                                                                                                    ...
                                                                                                                    Padding(
                                                                                                                      ...
                                                                                                                      child: SizedBox(
                                                                                                                        ...
                                                                                                                        child: CommonTextField(
                                                                                                                          ...
                                                                                                                          inputType: TextInputType.numberWithOptions(decimal: true),
                                                                                                                          label: AppLocalizations.of(context)!.enterSellPrice,
                                                                                                                          hintText: '0',
                                                                                                                        ),
                                                                                                                      ),
                                                                                                                    ),
                                                                                                                    ...
                                                                                                                    Padding(
                                                                                                                      ...
                                                                                                                      child: SizedBox(
                                                                                                                        ...
                                                                                                                        child: CommonTextField(
                                                                                                                          ...
                                                                                                                          onEditComplete: (value) {
                                                                                                                            debouncer.call(() {
                                                                                                                              ref.watch(sellWeight.notifier).state = double.tryParse(value) ?? 0.0;
                                                                                                                            });
                                                                                                                          },
                                                                                                                        ),
                                                                                                                      ),
                                                                                                                ...
                                                                                                                ref.watch(sbtTermsProvider(userType: "2", productId: "${dataList[mainIndex].productId}")).when(data: (data) => HtmlWidget(data['data'] ?? ""), error: (e, s) => Container(), loading: () => Center(child: CircularProgressIndicator())),
                                                                                                                Padding(
                                                                                                                  padding: EdgeInsets.only(top: 15),
                                                                                                                  child: Row(
                                                                                                                    children: [
                                                                                                                      ...
                                                                                                                      Expanded(
                                                                                                                        child: ElevatedButton(
                                                                                                                          style: AppStyle.buttonStyle.copyWith(backgroundColor: WidgetStatePropertyAll(ColorConstant.red500)),
                                                                                                                          onPressed: () async {
                                                                                                                            if (sellPriceController.text.isEmpty || double.tryParse(sellPriceController.text) == null || double.parse(sellPriceController.text) < 1) {
                                                                                                                              context.errorToast(AppLocalizations.of(context)!.pleaseInputValidValue);
                                                                                                                            } else {
                                                                                                                              if (ref.watch(sellWeight) > 0.0) {
                                                                                                                                if (sellKey.currentState!.validate()) {
                                                                                                                                  ElevarmConfirmAlertDialog(
                                                                                                                                          title: AppLocalizations.of(context)!.msgAreYousure,
                                                                                                                                          ...
                                                                                                                                          onPositiveButton: () {
                                                                                                                                            context.showLoader();
                                                                                                                                            ref.read(postSbtProvider(productId: "${dataList[mainIndex].productId}", commodityId: "${dataList[mainIndex].commodityId}", district_id: "${dataList[mainIndex].districtId}", qty: "${ref.watch(sellWeight)}", price: sellPriceController.text, type: "2").future).then((value) async {
                                                                                                                                              context.hideloader();
                                                                                                                                              if (value['status'].toString() == "1") {
                                                                                                                                                ...
                                                                                                                                                ref.invalidate(getSbtCommodityProvider);
                                                                                                                                                ref.invalidate(matchedOrdersProvider);
                                                                                                                                                Fluttertoast.showToast(msg: formatErrorMessage(context, value['message']), toastLength: Toast.LENGTH_LONG, backgroundColor: Colors.green);
                                                                                                                                              } else {
                                                                                                                                ...
                                                                                                                                Fluttertoast.showToast(msg: AppLocalizations.of(context)!.quantityShouldBeGreaterThan0, toastLength: Toast.LENGTH_LONG, backgroundColor: Colors.red);
                                                                                                                              }
                                                                                                                            }
                                                                                                                          },
                                                                                                                          child: Text(AppLocalizations.of(context)!.msgSubmit, style: TextStyle(fontSize: Adaptive.sp(18), fontFamily: 'Roboto', fontWeight: FontWeight.w500, color: Colors.white)),
                                                                                    ...
                                                                                    style: AppStyle.buttonStyle.copyWith(backgroundColor: WidgetStateProperty.resolveWith((states) => Colors.red)),
                                                                                    child: Text(
                                                                                      AppLocalizations.of(context)!.msgSell,
                                                                                      style: TextStyle(color: Colors.white, fontSize: Adaptive.sp(18)),
                                                                                    ),
                                                                            ...
                                                                            ElevarmLinkPrimaryButton.icon(
                                                                              buttonThemeData: ElevarmLinkButtonThemeData(onPrimaryColor: ColorConstant.maingreen),
                                                                              text: AppLocalizations.of(context)!.viewChart,
                                                                              onPressed: () {
                                                                                Get.to(BuySellData(
                                                                                  data: dataList[mainIndex],
                                                                                  index: data.data?.indexOf(dataList[mainIndex]),
                                                                                ));
                                                                              },
                                                                              leadingIconAssetName: CupertinoIcons.chart_bar,
                                                                              trailingIconAssetName: CupertinoIcons.forward,
                                                                            ),
                                                                            ElevarmDivider(),
                                                                            Column(
                                                                              ...
                                                                              children: [
                                                                                Container(
                                                                                  decoration: BoxDecoration(border: Border.all(color: ColorConstant.maingreen)),
                                                                                  child: BuyerList(data: dataList[mainIndex], index: mainIndex),
                                                                                ),
                                                                                ElevarmDivider(),
                                                                                Container(
                                                                                  decoration: BoxDecoration(border: Border.all(color: ColorConstant.red500)),
                                                                                  padding: Pad(all: 10),
                                                                                  child: SellerList(data: dataList[mainIndex], index: mainIndex),
                                                                                ),
                                                                                ElevarmDivider(),
                                                                              ],
                                                                            ),
                                                                            ...
                                                                            ref.watch(matchedOrdersProvider(productId: "${dataList[mainIndex].productId}")).when(
                                                                                data: (data) => (data.tradeOrderData ?? []).isEmpty
                                                                                    ? Center(
                                                                                    ...
                                                                                    : ListView.builder(
                                                                                        ...
                                                                                        itemBuilder: (BuildContext context, int index) {
                                                                                          return Card(
                                                                                            elevation: 5,
                                                                                            color: Colors.white,
                                                                                            shape: RoundedRectangleBorder(side: BorderSide(color: ColorConstant.maingreen.withOpacity(0.3)), borderRadius: BorderRadius.circular(10)),
                                                                                                  ...
                                                                                                  children: [
                                                                                                    Center(
                                                                                                      child: Text.rich(TextSpan(
                                                                                                        text: ref.watch(sharedUtilityProvider).getUser()?.firmName.toString().trim().toLowerCase() == data.tradeOrderData?[index].seller.toString().trim().toLowerCase()
                                                                                                            ? AppLocalizations.of(context)!.sellingDeal
                                                                                                            : AppLocalizations.of(context)!.buyingDeal,
                                                                                                        style: TextStyle(
                                                                                                          fontWeight: FontWeight.bold,
                                                                                                          color: ref.watch(sharedUtilityProvider).getUser()?.firmName.toString().trim().toLowerCase() == data.tradeOrderData?[index].seller.toString().trim().toLowerCase()
                                                                                                              ? Colors.red
                                                                                                              : ColorConstant.maingreen,
                                                                                                          fontSize: Adaptive.sp(17),
                                                                                                        ),
                                                                                                    ...
                                                                                                    Row(
                                                                                                      children: [
                                                                                                        TextOneLine(
                                                                                                          ...
                                                                                                          textAlign: TextAlign.center,
                                                                                                          style: TextStyle(color: ColorConstant.maingreen, fontWeight: FontWeight.w700, fontSize: Adaptive.sp(16)),
                                                                                                        ),
                                                                                                      ],
                                                                                                    ),
                                                                                                    ElevarmDivider(),
                                                                                                    ...
                                                                                                    Text.rich(TextSpan(text: "${data.tradeOrderData?[index].commodity}", style: TextStyle(color: ColorConstant.maingreen, fontWeight: FontWeight.w700, fontSize: Adaptive.sp(16)), children: [
                                                                                                      TextSpan(
                                                                                                        text: "- ${data.tradeOrderData?[index].district.toString()}",
                                                                                                        style: TextStyle(fontSize: Adaptive.sp(18), color: Colors.black, fontWeight: FontWeight.w500),
                                                                                                      )
                                                                                                    ])),
                                                                                                    ElevarmDivider(),
                                                                                                        ...
                                                                                                        Row(
                                                                                                          ...
                                                                                                          children: [
                                                                                                            Text(
                                                                                                              ...
                                                                                                              style: AppStyle.mystoke.copyWith(fontSize: Adaptive.sp(15), fontWeight: FontWeight.w700),
                                                                                                            ),
                                                                                                            SizedBox(
                                                                                                              width: 5,
                                                                                                            ),
                                                                                                            Text(
                                                                                                              currencyFormat.format(double.parse("${data.tradeOrderData?[index].rate ?? "0.0"}")),
                                                                                                              style: AppStyle.mystoke.copyWith(fontSize: Adaptive.sp(15), fontWeight: FontWeight.w700),
                                                                                                            )
                                                                                                          ],
                                                                                                        ),
                                                                                                    ...
                                                                                                    Row(
                                                                                                      ...
                                                                                                      children: [
                                                                                                        Text(
                                                                                                          ...
                                                                                                          style: AppStyle.mystoke.copyWith(fontSize: Adaptive.sp(16), fontWeight: FontWeight.w700),
                                                                                                        ),
                                                                                                        SizedBox(
                                                                                                          width: 10,
                                                                                                        ),
                                                                                                          ...
                                                                                                          TextButton(
                                                                                                              onPressed: () {
                                                                                                                ...
                                                                                                                if (dataList[mainIndex].sbtType.toString() == "1") {
                                                                                                                  ...
                                                                                                                  Get.to(FactoryDispatchRequestsScreen(
                                                                                                              ...
                                                                                                              child: Text(
                                                                                                                ...
                                                                                                                style: TextStyle(fontWeight: FontWeight.bold, color: ColorConstant.maingreen, fontSize: Adaptive.sp(16), decoration: TextDecoration.underline),
                                                                                                              )),
                                                                                                          TextButton(
                                                                                                              onPressed: () {
                                                                                                                Get.back();
                                                                                                                if (dataList[mainIndex].sbtType.toString() == "1") {
                                                                                                                  showModalBottomSheet(
                                                                                                                      ...
                                                                                                                      builder: (bottomsheetContext) => ElevarmDraggableBottomSheet(
                                                                                                                            title: AppLocalizations.of(context)!.markDelivery,
                                                                                                                  ...
                                                                                                                  showModalBottomSheet(
                                                                                                                      context: context,
                                                                                                                      builder: (bottomsheetContext) => ElevarmDraggableBottomSheet(title: '', onPressedClose: () => Get.back(), children: [
                                                                                                                            FactoryDispatchRequestsScreen(sbtOrder: data.tradeOrderData?[index].orderId ?? "")
                                                                                                                          ]),
                                                                                                                      isScrollControlled: true);
                                                                                                                }
                                                                                                              },
                                                                                                              child: Text(
                                                                                                                AppLocalizations.of(context)!.markDelivery,
                                                                                                                style: TextStyle(fontWeight: FontWeight.bold, color: ColorConstant.maingreen, fontSize: Adaptive.sp(16), decoration: TextDecoration.underline),
                                                                                                              )),
                                                                                                          TextButton(
                                                                                                              onPressed: () {
                                                                                                              ...
                                                                                                              child: Text(
                                                                                                                AppLocalizations.of(context)!.walletRefund,
                                                                                                                style: TextStyle(fontWeight: FontWeight.bold, color: ColorConstant.maingreen, fontSize: Adaptive.sp(16), decoration: TextDecoration.underline),
                                                                                                              ))
                                                                                                        ],
                                                                                                      ),

                                                                                                    if (ref.watch(sharedUtilityProvider).getUser()?.firmName.toString().toLowerCase() == data.tradeOrderData?[index].seller.toString().toLowerCase() && dataList[mainIndex].sbtType.toString() == "2")
                                                                                                      Row(
                                                                                                          ...
                                                                                                          Expanded(
                                                                                                              child: simpleButton(
                                                                                                                  ...
                                                                                                                  callback: () {
                                                                                                                    ...
                                                                                                                    if (dataList[mainIndex].sbtType.toString() == "1") {
                                                                                                                      Get.to(Sbtdeals(
                                                                                                                        selectedIndex: ref.watch(sharedUtilityProvider).getUser()?.firmName.toString().toLowerCase() == data.tradeOrderData?[index].buyer.toString().toLowerCase()
                                                                                                                            ? 1
                                                                                                                            : ref.watch(sharedUtilityProvider).getUser()?.firmName.toString().toLowerCase() == data.tradeOrderData?[index].seller.toString().toLowerCase()
                                                                                                                                ? 0
                                                                                                                                : 0,
                                                                                                                        sbtOrderId: data.tradeOrderData?[index].orderId ?? "",
                                                                                                                      ));
                                                                                                                    } else {
                                                                                                                      Get.to(Dispatchrequestslisting(orderId: data.tradeOrderData?[index].orderId ?? ""));
                                                                                                                    }
                                                                                                                  })),
                                                                                                          SizedBox(
                                                                                                            width: 10,
                                                                            ...
                                                                            Column(
                                                                              crossAxisAlignment: CrossAxisAlignment.start,
                                                                              children: [
                                                                                _commodityParamsLayout("${dataList[mainIndex].productId}", "${dataList[mainIndex].commodity}"),
                                                                                ElevarmDivider(),
                                                                                Row(
                                                                                  children: [
                                                                                    Center(
                                                                                        child: Text(
                                                                                      AppLocalizations.of(context)!.deliveryCenters,
                                                                                      style: TextStyle(
                                                                                        fontSize: Adaptive.sp(17),
                                                                                        fontWeight: FontWeight.w700,
                                                                                      ),
                                                                                ...
                                                                                _deliveryCenters("${dataList[mainIndex].productId}", "${dataList[mainIndex].sbtType}"),
                                                                              ],
                                                                            )
                                                                          ],
                                                                        )));
  ...
  _buySellListLoader() => Skeletonizer(
          child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          // Container(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            _buildPriceRow(
                              label:
                                  AppLocalizations.of(context)!.msgSellerBest,
                              value: currencyFormat.format(
                                0,
                              ),
                            ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(AppLocalizations.of(context)!.charges,
                                  style: TextStyle(
                                      fontSize: Adaptive.sp(17),
                                      fontWeight: FontWeight.bold,
                                      color: Colors.white)),
        ...
        children: [
          ...
          Padding(
            ...
            child: RowSuper(fill: true, children: [
              DataTable(
                  headingRowColor:
                      WidgetStateProperty.all(ColorConstant.maingreen),
                  ...
                  columns: [
                    ...
                    DataColumn(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text(AppLocalizations.of(context)!.extreme,
                              style: TextStyle(
                                fontSize: Adaptive.sp(17),
                                fontWeight: FontWeight.w500,
                              ))
            ...
            return ref.watch(warehouseListProvider(id: productId)).when(
                data: (value) {
                  var deliveryCenterList = value.data
                      ?.where((e) =>
                          num.parse(e.emptySpace.toString())
                              .toStringAsFixed(0) !=
                          "0")
                      .toList();
                      ...
                      itemBuilder: (context, whIndex) {
                        ...
                        if (item?.lat != null && item?.long != null) {
                          distanceKm = Geolocator.distanceBetween(
                                  ...
                                  double.tryParse(item.long.toString()) ??
                                      0.0) /
                                                                    ...
                                                                    Text.rich(
                                                                        TextSpan(
                                                                            text: AppLocalizations.of(context)!
                                                                                .exitLoad,
                                                                            children: [
                                                                              TextSpan(text: "\n${AppLocalizations.of(context)!.outwards}", style: TextStyle(color: Colors.red))
                                                                            ]),
                                                                        style: TextStyle(
                                                                            fontSize:
                                                                                Adaptive.sp(16),
                                                                ...
                                                                child:
                                                                    Text.rich(
                                                                        TextSpan(
                                                                            ...
                                                                            children: [
                                                                              TextSpan(text: '\n${AppLocalizations.of(context)!.stockist}', style: TextStyle(color: Colors.red))
                                                                            ]),
                                                                        style: TextStyle(
                                                                            fontSize:
                                                                                Adaptive.sp(16),
  ...
  Widget _commodityParamsLayout(dynamic productId, dynamic commodity) =>
      Consumer(
          builder: (context, ref, child) =>
              ref.watch(productQualityProvider(id: "$productId")).when(
                  data: (value) => Padding(
  ...
  _handleBuyOption(dynamic dataList, dynamic mainIndex,
      BuildContext bottomsheetContext, double quantity, double price) {
    ElevarmConfirmAlertDialog(
            title: AppLocalizations.of(context)!.areYouSure,
            subtitle:
                '${AppLocalizations.of(context)!.commodityPrice}: ${price.toString()}\n${AppLocalizations.of(context)!.commodityWeight}: ${ref.watch(buyWeight)} in Quintal',
            onPositiveButton: () {
              Get.back();
              context.showLoader();

              ref
                  .read(checkForUserWalletProvider(
                ...
                qty: ref.read(buyWeight).toString(),
                type: "1",
                  ...
                  ref
                    ...
                    if (value['status'].toString() == "1") {
                      ...
                      Fluttertoast.showToast(
                          msg: formatErrorMessage(context, value['message']),
                                                                        ...
                                                                        SizedBox(
                                                                          ...
                                                                          child: value['data'] == null
                                                                              ...
                                                                              : ColumnSuper(children: [
                                                                                    ...
                                                                                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                                      Expanded(
                                                                                        child: Text(
                                                                                          ...
                                                                                          textAlign: TextAlign.center,
                                                                                          style: TextStyle(fontSize: Adaptive.sp(17), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.white, fontWeight: FontWeight.w800),
                                                                                        ),
                                                                                      ),
                                                                                      Expanded(
                                                                                          child: Text(
                                                                                        AppLocalizations.of(context)!.schemeName,
                                                                                        textAlign: TextAlign.center,
                                                                                        style: TextStyle(fontSize: Adaptive.sp(17), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.white, fontWeight: FontWeight.w800),
                                                                                      )),
                                                                                      Expanded(child: Text(AppLocalizations.of(context)!.pf_1, textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(17), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.white, fontWeight: FontWeight.w800))),
                                                                                      Expanded(child: Text(AppLocalizations.of(context)!.interestRate_1, textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(17), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.white, fontWeight: FontWeight.w800))),
                                                                                      Expanded(child: Text(AppLocalizations.of(context)!.ltv_1, textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(17), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.white, fontWeight: FontWeight.w800))),
                                                                                      Expanded(child: Text(AppLocalizations.of(context)!.tenor, textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(17), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.white, fontWeight: FontWeight.w800))),
                                                                                      // Expanded(
                                                                                      //     child: Text("Days",
                                                                                      //         textAlign: TextAlign.center,
                                                                                      //         style: TextStyle(
                                                                                  ...
                                                                                  ListView.builder(
                                                                                    itemCount: value['data']['schemes']?.length ?? 0,
                                                                                    shrinkWrap: true,
                                                                                    itemBuilder: (context, index) => value['data']['schemes'][index]['scheme_name'].toString().toLowerCase().trim() == "bnpl takeover"
                                                                                        ? SizedBox()
                                                                                        : Container(
                                                                                              ...
                                                                                              child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                                                Expanded(
                                                                                                  child: Checkbox(
                                                                                                      ...
                                                                                                      value: ref.watch(selectedIndex) == index,
                                                                                                ...
                                                                                                Expanded(child: Text("${value['data']['schemes'][index]['scheme_name'] ?? ""}", textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(17), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.black, fontWeight: FontWeight.w800))),
                                                                                                Expanded(child: Text("${value['data']['schemes'][index]['processing_fee'] ?? ""}", textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(17), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.black, fontWeight: FontWeight.w800))),
                                                                                                Expanded(child: Text("${value['data']['schemes'][index]['interest_rate'] ?? ""}", textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(17), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.black, fontWeight: FontWeight.w800))),
                                                                                                Expanded(child: Text("${value['data']['schemes'][index]['ltv'] ?? ""}", textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(17), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.black, fontWeight: FontWeight.w800))),
                                                                                                Expanded(child: Text("${value['data']['schemes'][index]['tenor']} ${value['data']['schemes'][index]['tenor_type']}", textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(17), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.black, fontWeight: FontWeight.w800))),
                                                                                                // Expanded(
                                                                                                //     child: Text(
                                                                                                //         data.data?[index]
                                                                                                //                 .loanPassDays ??
                                                                                    ...
                                                                                    child: ElevatedButton(
                                                                                      onPressed: () {
                                                                                        if (ref.watch(selectedIndex) == null) {
                                                                                          Fluttertoast.showToast(msg: AppLocalizations.of(context)!.pleaseSelectScheme);
                                                                                        } else {
                                                                                          context.showLoader();
                                                                                          ref.read(postSbtProvider(productId: "${dataList[mainIndex ?? 0].productId}", commodityId: "${dataList[mainIndex ?? 0].commodityId}", district_id: "${dataList[mainIndex ?? 0].districtId}", qty: "${ref.watch(buyWeight)}", price: price.toString(), type: "1", loanType: "2", schemeId: "${value['data']['schemes'][ref.watch(selectedIndex)]['id']}").future).then((value) {
                                                                                            context.hideloader();
                                                                                            if (value['status'].toString() == "0") {
                                                                                              Fluttertoast.showToast(msg: formatErrorMessage(context, value['message']), toastLength: Toast.LENGTH_LONG, backgroundColor: Colors.red, textColor: Colors.white);
                                                                                            } else {
