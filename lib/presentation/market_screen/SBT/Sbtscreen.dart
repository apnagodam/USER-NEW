                                                          ...
                                                          children: [
                                                            Padding(
                                                              padding:
                                                                  Pad(all: 10),
                                                              child: Text(
                                                                '${AppLocalizations.of(context)!.labourRate}  ${item?.labourRate ?? 0}₹ / per Qtl.',
                                                                style:
                                                                    TextStyle(
                                                                  fontSize:
                                                                      Adaptive.sp(
        ...
        ref
          ...
          if (value["error"].toString().toLowerCase() == "no") {
            ...
            ref
              ...
              context.hideloader();
              showErrorAlertDialog(context, "$e");
            });
          } else {
             context.hideloader();
             ...
             if (errorType == 'wallet' && walletType == 'finance') {
                showModalBottomSheet(
                  context: context,
                  builder: (financeSheetContext) => ElevarmDraggableBottomSheet(
                    title: AppLocalizations.of(
                      context,
                    )!
                        .youDontHaveSufficientBalance,
                    onPressedClose: () => Navigator.of(financeSheetContext).pop(),
                    footerWidget: Row(
                      children: [
                        Expanded(
                          child: ElevatedButton(
                                ...
                                if (value['wallet_type'] != null) {
                                  if (value['error'].toString().toLowerCase() ==
                                      ...
                                      value['wallet_type']
                                              ...
                                              .toLowerCase() ==
                                          "bnpl") {
                                    Navigator.of(financeSheetContext).pop();
                                    Get.to(
                                      AddMoney(
                                        isAppBarVisible: true,
                                      ),
                                      ...
                                      builder: (
                                        ...
                                        title: AppLocalizations.of(
                                          context,
                                            ...
                                            .pleaseSelectScheme,
                                        onPressedClose: () => Navigator.of(schemeSheetContext).pop(),
                                        children: [
                                          Consumer(
                                            builder: (
                                              context,
                                                                ...
                                                                ref
                                                                  ...
                                                                  postSbtProvider(
                                                                    ...
                                                                    loanType:
                                                                        "2",
                                                                    schemeId:
                                                                        "${value['data']['schemes'][ref.read(selectedIndex)]['id']}",
                                                                  ).future,
                                                                )
                                                                    .then(
                                                                  (
              ...
              showErrorAlertDialog(
                context,
                value['message'] ?? 'Trade limit error',
              );
            }
          }
        }).onError((e, s) {});
