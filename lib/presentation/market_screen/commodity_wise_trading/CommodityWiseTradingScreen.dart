...
import 'package:apnagodam/database/Database.dart';
...
class Commoditywisetradingscreen extends ConsumerStatefulWidget {
  Commoditywisetradingscreen(
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _CommoditywisetradingscreenState();
}

class _CommoditywisetradingscreenState
    extends ConsumerState<Commoditywisetradingscreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Center(child: Text(AppLocalizations.of(context)!.trading)),
          actions: [
            Padding(
            ...
            children: [
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            Text(
                              AppLocalizations.of(context)!.msgChooseoption,
                ...
                child: Row(
                  ...
                  children: [
                      ...
                      child: InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              color: ref.watch(tabIndexProvider) == 0
                          ...
                          child: Center(
                              child: Text(
                            AppLocalizations.of(context)!.wbt,
                    ...
                    Expanded(
                      child: InkWell(
                        onTap: () {
                          ref.watch(tabIndexProvider.notifier).state = 1;
                        },
                        child: Container(
                          height: 48,
                          decoration: BoxDecoration(
                            color: ref.watch(tabIndexProvider) == 1
                                ? ColorConstant.maingreen
                                : Colors.white,
                          ...
                          child: Center(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                fontWeight: FontWeight.bold, //msg_lying
                                color: ref.watch(tabIndexProvider) == 1
                                    ? Colors.white
                                    : ColorConstant.maingreen,
                              ),
                    ...
                    //   child: InkWell(
                    //     onTap: () {
                    //       ref.watch(tabIndexProvider.notifier).state = 2;
                    //     },
                    //     child: Container(
                    //       height: 48,
                    //       decoration: BoxDecoration(
              ...
              ref.watch(tabIndexProvider) == 0
                  ? RefreshIndicator(
                          ...
                          data: (data) {
                            ...
                            if ((data.data ?? []).isNotEmpty) {
                              for (var i = 0; i < data.data!.length; ++i) {
                                if (widget.commodityName
                                    .toString()
                                    .toLowerCase()
                                    .removeAllWhitespace
                                    .contains('-')) {
                                  var commodity = widget.commodityName
                                      .toString()
                                      .toLowerCase()
                                      .removeAllWhitespace
                                      .substring(
                                          ...
                                          widget.commodityName
                                              ...
                                              .toLowerCase()
                                              .indexOf('-'));
                                  if (data.data![i].commodity
                                      .toString()
                                      .toLowerCase()
                                      .contains(commodity)) {
                                    distinctList.add(data.data![i]);
                                  }
                                } else {
                                  if (data.data![i].commodity
                                      .toString()
                                      ...
                                      .removeAllWhitespace
                                      .contains('-')) {
                                    var commodity = data.data![i].commodity
                                        .toString()
                                        .toLowerCase()
                                        .substring(
                                            0,
                                            data.data![i].commodity
                                                .toString()
                                                .toLowerCase()
                                                .indexOf('-'));
                                    if (widget.commodityName
                                    ...
                                    if (widget.commodityName
                                        ...
                                        .toLowerCase()
                                        .removeAllWhitespace
                                        .contains(data.data![i].commodity
                                            .toString()
                                            .removeAllWhitespace
                                            .toLowerCase())) {
                                      distinctList.add(data.data?[i]);
                                              ...
                                              onTap: () async {
                                                SharedPreferences prefs =
                                                    await SharedPreferences
                                                        .getInstance();
                                                Get.to(Bidding(
                                                  id: distinctList[index]
                                                      ?.sellerCatId
                                                      .toString(),
                                                  sellerID: distinctList[index]
                                                      ?.sellerId
                                                      .toString(),
                                                ));
                                              },
                                                              ...
                                                              children: [
                                                                CircleImageView(
                                                                  radius:
                                                                      Adaptive.sp(
                                                                          22),
                                                                  image:
                                                                      "${IMAGE_BASE_URL}category/${distinctList[index]?.image.toString()}",
                                                                ),
                                                                ...
                                                                Column(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Text(
                                                                      "Last Trade Price: ${distinctList[index]?.ltp}",
                                                                      style: AppStyle.lblonbordingp.copyWith(
                                                                    ...
                                                                    InkWell(
                                                                      onTap:
                                                                        ...
                                                                        final result =
                                                                            Get.to(GraphScreen(
                                                                          id: "${distinctList[index]?.sellerCatId}",
                                                                          wichtag:
                                                                              "market",
                                                                        ));
                                                                      },
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text.rich(TextSpan(
                                                                      ...
                                                                      children: [
                                                                        TextSpan(
                                                                            text:
                                                                                "${distinctList[index]?.sellerPrice}")
                                                                      ])),
                                                                ],
                                                              )
                                                            ],
                      ...
                      onRefresh: () =>
                          Future(() => ref.invalidate(getMandiBhavProvider)))
                  : ref.watch(tabIndexProvider) == 1
                      ? RefreshIndicator(
                          ...
                          child: ref.watch(getSbtCommodityProvider).when(
                          data: (data) {
                            List<SbtDatum>? dataList = [];
                            if ((data.data ?? []).isNotEmpty) {
                              for (var i = 0; i < data.data!.length; ++i) {
                                if (widget.commodityName
                                    .toString()
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          Expanded(
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              ref.watch(buyPrice.notifier).state = double.parse('${dataList?[mainIndex ?? 0].lowerCircuit}');
                                                                                            ...
                                                                                            child: Column(mainAxisSize: MainAxisSize.min, children: [
                                                                                              ...
                                                                                              Center(
                                                                                                child: Padding(
                                                                                                  ...
                                                                                                  child: Text.rich(TextSpan(text: "Product", style: TextStyle(fontSize: Adaptive.sp(16), fontWeight: FontWeight.bold), children: [
                                                                                                    TextSpan(text: " : ${data.data?[mainIndex ?? 0].commodity} (${data.data?[mainIndex ?? 0].district})")
                                                                                                  ])),
                                                                                                ),
                                                                                              ),
                                                                                              SizedBox(
                                                                                              ...
                                                                                              RowSuper(
                                                                                                ...
                                                                                                children: [
                                                                                                  ...
                                                                                                  Text.rich(TextSpan(text: "Date: ", style: TextStyle(fontSize: Adaptive.sp(16), fontFamily: 'Roboto', fontWeight: FontWeight.bold), children: [
                                                                                                    TextSpan(text: "${dataList?[mainIndex ?? 0].date}", style: TextStyle(fontSize: Adaptive.sp(16), fontFamily: 'Roboto', color: ColorConstant.maingreen, fontWeight: FontWeight.bold))
                                                                                                  ]))
                                                                                                ],
                                                                                              ),
                                                                                              Divider(),
                                                                                                ...
                                                                                                children: [
                                                                                                  ...
                                                                                                  Padding(
                                                                                                    ...
                                                                                                    child: SizedBox(
                                                                                                      width: Get.width,
                                                                                                      child: InputQty(
                                                                                                          initVal: dataList?[mainIndex ?? 0].lowerCircuit ?? 0,
                                                                                                          steps: 10,
                                                                                                          onQtyChanged: (val) {
                                                                                                            ref.watch(buyPrice.notifier).state = double.parse("${val ?? 0.0}");
                                                                                                            print(val);
                                                                                                          },
                                                                                                      ...
                                                                                                      Padding(
                                                                                                        ...
                                                                                                        child: SizedBox(
                                                                                                          ...
                                                                                                          child: InputQty(
                                                                                                              ...
                                                                                                              steps: 10,
                                                                                                              onQtyChanged: (val) {
                                                                                                                ref.watch(buyWeight.notifier).state = double.parse("${val ?? 0.0}");
                                                                                                  ...
                                                                                                  children: [
                                                                                                    Expanded(
                                                                                                      child: ElevatedButton(
                                                                                                          ...
                                                                                                          child: Text(AppLocalizations.of(context)!.msgCencel, style: TextStyle(fontSize: Adaptive.sp(16), fontFamily: 'Roboto', fontWeight: FontWeight.w500, color: Colors.white))),
                                                                                                    ),
                                                                                                    SizedBox(
                                                                                                      width: 20,
                                                                                                    ),
                                                                                                    Expanded(
                                                                                                      child: ElevatedButton(
                                                                                                        ...
                                                                                                        child: Text("Submit", style: TextStyle(fontSize: Adaptive.sp(16), fontFamily: 'Roboto', fontWeight: FontWeight.w500, color: Colors.white)),
                                                                                                      ),
                                                                                                    )
                                                                                                  ],
                                                                                                ),
                                                                          ...
                                                                          Expanded(
                                                                            ...
                                                                            onPressed:
                                                                                () async {
                                                                              ref.watch(sellPrice.notifier).state = double.parse('${dataList?[mainIndex ?? 0].lowerCircuit}');
                                                                                            ...
                                                                                            child: Wrap(children: [
                                                                                              ...
                                                                                              Center(
                                                                                                child: Padding(
                                                                                                  padding: EdgeInsets.only(bottom: 8.0),
                                                                                                  child: Text.rich(TextSpan(text: "Product", style: TextStyle(fontSize: Adaptive.sp(16), fontWeight: FontWeight.bold), children: [
                                                                                                    TextSpan(text: " : ${dataList?[mainIndex ?? 0].commodity} (${dataList?[mainIndex ?? 0].district})")
                                                                                                  ])),
                                                                                                ),
                                                                                              ),
                                                                                              SizedBox(
                                                                                              ...
                                                                                              RowSuper(
                                                                                                ...
                                                                                                children: [
                                                                                                  ...
                                                                                                  //                       .bold))
                                                                                                  //     ])),
                                                                                                  Text.rich(TextSpan(text: "Date: ", style: TextStyle(fontSize: Adaptive.sp(16), fontWeight: FontWeight.bold), children: [
                                                                                                    TextSpan(text: "${dataList?[mainIndex ?? 0].date}", style: TextStyle(fontSize: Adaptive.sp(16), fontFamily: 'Roboto', color: ColorConstant.maingreen, fontWeight: FontWeight.bold))
                                                                                                  ]))
                                                                                                ],
                                                                                              ),
                                                                                                  ...
                                                                                                  Padding(
                                                                                                    ...
                                                                                                    child: SizedBox(
                                                                                                      ...
                                                                                                      child: InputQty(
                                                                                                          ...
                                                                                                          steps: 10,
                                                                                                          onQtyChanged: (val) {
                                                                                                            ref.watch(sellPrice.notifier).state = double.parse('${val ?? 0.0}');
                                                                                                          },
                                                                                                          decoration: QtyDecorationProps(
                                                                                                              border: OutlineInputBorder(borderRadius: BorderRadius.circular(5), borderSide: BorderSide(color: ColorConstant.maingreen)),
                                                                                                              qtyStyle: QtyStyle.classic,
                                                                                                  ...
                                                                                                  Padding(
                                                                                                    ...
                                                                                                    child: SizedBox(
                                                                                                      ...
                                                                                                      child: InputQty(
                                                                                                          ...
                                                                                                          steps: 10,
                                                                                                          onQtyChanged: (val) {
                                                                                                            ref.watch(sellWeight.notifier).state = double.parse("${val ?? 0.0}");
                                                                                                          },
                                                                                                          decoration: QtyDecorationProps(
                                                                                                              border: OutlineInputBorder(borderRadius: BorderRadius.circular(5), borderSide: BorderSide(color: ColorConstant.maingreen)),
                                                                                                              qtyStyle: QtyStyle.classic,
                                                                                                  ...
                                                                                                  children: [
                                                                                                    ...
                                                                                                    Expanded(
                                                                                                      child: ElevatedButton(
                                                                                                        ...
                                                                                                        onPressed: () async {
                                                                                                          if (ref.watch(sellPrice) < 1) {
                                                                                                            context.errorToast('Please input proper selling price');
                                                                                                          } else {
                                                                            ...
                                                                            style:
                                                                                AppStyle.buttonStyle.copyWith(backgroundColor: MaterialStateProperty.resolveWith((states) => Colors.red)),
                                                                            child:
                                                                                Text(
                                                                    ...
                                                                    ElevarmLinkPrimaryButton
                                                                      ...
                                                                      buttonThemeData:
                                                                          ElevarmLinkButtonThemeData(
                                                                              onPrimaryColor: ColorConstant.maingreen),
                                                                      text:
                                                                          'View Chart',
                                                                      onPressed:
                                                                          () {
                                                                                          ...
                                                                                          children: [
                                                                                            Center(
                                                                                              child: Text.rich(TextSpan(
                                                                                                text: ref.watch(sharedUtilityProvider).getUser()?.firmName.toString().toLowerCase() == data.tradeOrderData?[index].buyer.toString().toLowerCase()
                                                                                                    ? "Buying Deal"
                                                                                                ...
                                                                                                style: TextStyle(
                                                                                                  fontWeight: FontWeight.bold,
                                                                                                  color: ref.watch(sharedUtilityProvider).getUser()?.firmName.toString().toLowerCase() == data.tradeOrderData?[index].buyer.toString().toLowerCase()
                                                                                                      ? ColorConstant.maingreen
                                                                                                      : ref.watch(sharedUtilityProvider).getUser()?.firmName.toString().toLowerCase() == data.tradeOrderData?[index].seller.toString().toLowerCase()
                                                                                                          ? Colors.red
                                                                                                          : ColorConstant.maingreen,
                                                                                            ...
                                                                                            Text.rich(TextSpan(text: "${data.tradeOrderData?[index].commodity}", style: TextStyle(color: ColorConstant.maingreen, fontWeight: FontWeight.w700, fontSize: Adaptive.sp(16)), children: [
                                                                                              TextSpan(
                                                                                                ...
                                                                                                style: TextStyle(fontSize: Adaptive.sp(16), color: Colors.black, fontWeight: FontWeight.w500),
                                                                                              )
                                                                                            ])),
                                                                                            ElevarmDivider(),
                                                                                                  ...
                                                                                                  TextButton(
                                                                                                      onPressed: () {
                                                                                                        ...
                                                                                                        if (dataList[mainIndex].sbtType.toString() == "1") {
                                                                                                          ...
                                                                                                          Get.to(Dispatchrequestslisting(
  ...
  Widget _deliveryCenters(dynamic productId, dynamic sbtType) => Consumer(
        builder: (context, ref, child) =>
            ref.watch(warehouseListProvider(id: productId)).when(
                data: (value) {
                  ...
                  data: (value) => Padding(
                      ...
                      child: ColumnSuper(
                        children: [
                          ...
                          Center(
                              child: Text(
                            "${"Quality Parameters".tr}  - ${commodity}",
                            style: TextStyle(
                              fontSize: Adaptive.sp(17),
                              fontWeight: FontWeight.w700,
                            ),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                              child: simpleButton(
                                  text: 'Dispatch'.tr, callback: () {})),
                          SizedBox(
                            width: 10,
                          ),
                          Expanded(
                              child: simpleButton(
                                  text: AppLocalizations.of(context)!.msgGrn, callback: () {})),
                          SizedBox(
                            width: 10,
                          ),
                          Expanded(
  ...
  _handleBuyOption(
      dynamic dataList, dynamic mainIndex, BuildContext bottomsheetContext) {
    ElevarmConfirmAlertDialog(
            title: 'Are you sure?',
            subtitle:
                                                                                    ...
                                                                                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                                      Expanded(
                                                                                        child: Text(
                                                                                          "Action",
                                                                                          textAlign: TextAlign.center,
                                                                                          style: TextStyle(fontSize: Adaptive.sp(15), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.white, fontWeight: FontWeight.w800),
                                                                                        ),
                                                                                      ),
                                                                                      Expanded(
                                                                                          child: Text(
                                                                                      ...
                                                                                      Expanded(child: Text("PF(%)", textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(16), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.white, fontWeight: FontWeight.w800))),
                                                                                      Expanded(child: Text("Interest Rate(%)", textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(16), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.white, fontWeight: FontWeight.w800))),
                                                                                      Expanded(child: Text("LTV(%)", textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(16), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.white, fontWeight: FontWeight.w800))),
                                                                                      Expanded(child: Text("Tenor", textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(16), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.white, fontWeight: FontWeight.w800))),
                                                                                      // Expanded(
                                                                                      //     child: Text("Days",
                                                                                      //         textAlign: TextAlign.center,
                                                                                      //         style: TextStyle(
                                                                                        ...
                                                                                        : Container(
                                                                                            ...
                                                                                            child: Padding(
                                                                                              ...
                                                                                              child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                                                ...
                                                                                                Expanded(child: Text("${value['data']['schemes'][index]['scheme_name'] ?? ""}", textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(16), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.black, fontWeight: FontWeight.w800))),
                                                                                                Expanded(child: Text("${value['data']['schemes'][index]['processing_fee'] ?? ""}", textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(16), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.black, fontWeight: FontWeight.w800))),
                                                                                                Expanded(child: Text("${value['data']['schemes'][index]['interest_rate'] ?? ""}", textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(16), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.black, fontWeight: FontWeight.w800))),
                                                                                                Expanded(child: Text("${value['data']['schemes'][index]['ltv'] ?? ""}", textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(16), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.black, fontWeight: FontWeight.w800))),
                                                                                                Expanded(child: Text("${value['data']['schemes'][index]['tenor']} ${value['data']['schemes'][index]['tenor_type']}", textAlign: TextAlign.center, style: TextStyle(fontSize: Adaptive.sp(16), shadows: [Shadow(color: Colors.white, blurRadius: 1, offset: Offset(0.2, 0.2))], color: Colors.black, fontWeight: FontWeight.w800))),
                                                                                                // Expanded(
                                                                                                //     child: Text(
                                                                                                //         data.data?[index]
                                                                                                //                 .loanPassDays ??
