...
class Commoditywisetradingscreen extends ConsumerStatefulWidget {
  const Commoditywisetradingscreen({
    super.key,
      ...
      appBar: AppBar(
        ...
        actions: [
          Padding(
            ...
            child: Icon(Icons.notifications, color: ColorConstant.maingreen),
          ),
        ],
      ),
                                                          ...
                                                          InkWell(
                                                            onTap: () async {
                                                              final result = Get.to(
                                                                GraphScreen(
                                                                  id:
                                                                      "${distinctList[index]?.sellerCatId}",
                                                                  wichtag:
                                                                      "market",
                                                                ),
                                                              );
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(
                        AppLocalizations.of(context)!.tapForDetails3,
                        style: AppStyle.mystoke.copyWith(
                          fontSize: Adaptive.sp(15),
                          fontWeight: FontWeight.w700,
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Row(
                      children: [
                        Text(
                          AppLocalizations.of(context)!.rate3,
                          style: AppStyle.mystoke.copyWith(
                            fontSize: Adaptive.sp(16),
                            fontWeight: FontWeight.w700,
                          ),
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          AppLocalizations.of(context)!.quantity3,
                          style: AppStyle.mystoke.copyWith(
                            fontSize: Adaptive.sp(16),
                            fontWeight: FontWeight.w700,
                          ),
                ...
                Row(
                  ...
                  children: [
                    Text(
                      AppLocalizations.of(context)!.pendingQuantity3,
                      style: AppStyle.mystoke.copyWith(
                        fontSize: Adaptive.sp(16),
                        fontWeight: FontWeight.w700,
                      ),
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: simpleButton(
                        text: AppLocalizations.of(context)!.dispatch3,
                        callback: () {},
                      ),
                    ),
                    SizedBox(width: 10),
                    ...
                    Expanded(
                      child: simpleButton(
                        text: AppLocalizations.of(context)!.payment3,
                        callback: () {
                          Get.back();
                          Get.to(Wallet());
                        },
                  ...
                  DataColumn(
                    label: Expanded(
                      child: Row(
                        ...
                        children: [
                          Text(
                            AppLocalizations.of(context)!.normal3,
                            style: TextStyle(
                              fontSize: Adaptive.sp(16),
                              fontWeight: FontWeight.w500,
                            ),
                  ...
                  DataColumn(
                    label: Expanded(
                      child: Row(
                        ...
                        children: [
                          Text(
                            AppLocalizations.of(context)!.extreme3,
                            style: TextStyle(
                              fontSize: Adaptive.sp(16),
                              fontWeight: FontWeight.w500,
                            ),
