...
//
//     final warehouseDefaultListModel = warehouseDefaultListModelFromMap(jsonString);

import 'dart:convert';

WarehouseDefaultListModel warehouseDefaultListModelFromMap(String str) =>
    WarehouseDefaultListModel.fromMap(json.decode(str));

String warehouseDefaultListModelToMap(WarehouseDefaultListModel data) =>
    json.encode(data.toMap());

class WarehouseDefaultListModel {
  ...
  factory WarehouseDefaultListModel.fromMap(Map<String, dynamic> json) =>
      WarehouseDefaultListModel(
