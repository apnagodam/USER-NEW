                    ...
                    child: Column(
                      ...
                      children: [
                        ref.watch(settingsProvider).when(
                              data: (data) => customWalletTitle(
                                title: "${data.settings?.accountHolder}",
                        ...
                        Center(
                          child: Text(
                            AppLocalizations.of(context)!.msgWalletAmount,
                            style: TextStyle(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    Text(
                                      currencyFormat.format(
                                        userData.userDetails?.holdPower
                                            .toString()
                                            .convertToDouble(
                                              defaultValue: 0.00,
                                            ),
