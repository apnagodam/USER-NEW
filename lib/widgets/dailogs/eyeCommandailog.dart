...
void EycCommanDialog(
    String? commoditImage,
    String? type,
    String? buyerseller,
    String? loaction,
    String? commodity,
                    ...
                    IntrinsicHeight(
                      child: Row(
                        children: [
                          Expanded(
                              child: Text(
                            AppLocalizations.of(context)!.msgCommodityimg,
                                ...
                                onPressed: () {
                                  Get.defaultDialog(
                                      ...
                                      content: Image.network(
                                          "${IMAGE_BASE_URL}category/$commoditImage"));
                                },
                                icon: Icon(
                    ...
                    IntrinsicHeight(
                      child: Row(
                        children: [
                          Expanded(
                              child: Text(
                            AppLocalizations.of(context)!.msgBuysell,
                            style: AppStyle.lbleyepopup,
                          )),
                          const Expanded(
                            child: VerticalDivider(
                    ...
                    IntrinsicHeight(
                      child: Row(
                        children: [
                          Expanded(
                              child: Text(
                            AppLocalizations.of(context)!.totalBages,
                            style: AppStyle.lbleyepopup,
                          )),
                          const Expanded(
                            child: VerticalDivider(
