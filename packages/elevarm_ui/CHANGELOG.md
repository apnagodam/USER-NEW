...
## [0.13.4] - 13-02-2026
### Added
- Add `tagValues` property in `ElevarmTabBar` widget.

### Changed
- Make `suffixIconAssetName` and `suffixAddOnText` combined in `ElevarmTextInputField` widget.

### Fixed
- Fix `ElevarmTabBar` label not in line when using tag value.

## [0.13.3] - 08-12-2025
### Added
- Add `buildLink` property to `ElevarmBreadcrumb` widget.
- Add `buildListTile` property to `ElevarmDrawer` widget.
- Add `badge` proprety to `ElevarmExpandableCard` Widget

## [0.13.2] - 25-09-2025
### Added
- Add `ElevarmThumbnailImage` widget.
- Add `ElevarmThumbnailImageInput` widget.

## [0.13.1] - 25-09-2025
### Added
- Add `hasTopDivider` and `onTap` variables in `ElevarmDrawerMenu` widget.
- Add `logoutMenuTitle` and `isLogoutInMainMenus` variables in `ElevarmDrawer` widget.

### Changed
- Update `ElevarmDrawer` widget to show logout menu if `isLogoutInMainMenus` is true.

## [0.13.0] - 29-08-2025
### Added
- Add `useMaybePop` parameter in `buildDialogBackground` method.
- Add `ElevarmExpandableCard` widget.
- Add checkbox parameters to `ElevarmDataTableColumnModel`.
- Add `ElevarmTypeaheadInputFieldV2` widget.

### Deprecated
- Deprecate `ElevarmAutocompleteInputField` widget.
- Deprecate `ElevarmTypeAheadInputField` widget.

## [0.12.2] - 11-07-2025
### Added
- Add `enableDynamicItemHeight` parameter in `ElevarmAutocompleteInputField` widget.

### Changed
- Bump `elevarm_icons` version to 1.3.1.

## [0.12.1] - 08-07-2025
### Changed
- Assign widget.key as global key in `ElevarmDropdownInputField`.
- Assign widget.key as global key in `ElevarmTextDropdownInputField`.
...
[Unreleased]: https://bitbucket.org/elevarm/elevarm_ui/branches/compare/dev%0Dv0.13.4
[0.13.4]: https://bitbucket.org/elevarm/elevarm_ui/branches/compare/v0.13.4%0Dv0.13.3
[0.13.3]: https://bitbucket.org/elevarm/elevarm_ui/branches/compare/v0.13.3%0Dv0.13.2
[0.13.2]: https://bitbucket.org/elevarm/elevarm_ui/branches/compare/v0.13.2%0Dv0.13.1
[0.13.1]: https://bitbucket.org/elevarm/elevarm_ui/branches/compare/v0.13.1%0Dv0.13.0
[0.13.0]: https://bitbucket.org/elevarm/elevarm_ui/branches/compare/v0.13.0%0Dv0.12.2
[0.12.2]: https://bitbucket.org/elevarm/elevarm_ui/branches/compare/v0.12.2%0Dv0.12.1
[0.12.1]: https://bitbucket.org/elevarm/elevarm_ui/branches/compare/v0.12.1%0Dv0.12.0
