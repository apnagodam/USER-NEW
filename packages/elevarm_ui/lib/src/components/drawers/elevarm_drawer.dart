...
class ElevarmDrawerMenu {
  ...
  /// The menu action callback if exist.
...
class ElevarmDrawer extends StatelessWidget {
  ...
  /// Whether to show logout button in main menus.
  final bool isLogoutInMainMenus;

  final Widget Function(
    BuildContext context,
    ElevarmDrawerMenu menu,
    Widget child,
  )? buildListTile;
  ...
  const ElevarmDrawer({
    ...
    this.isLogoutInMainMenus = false,
    this.buildListTile,
    super.key,
  });
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Builder(
                  builder: (context) {
                    List<ElevarmDrawerMenu> newMainMenus = [...mainMenus];
                    if (isLogoutInMainMenus) {
                      newMainMenus.add(
                        ElevarmDrawerMenu(
                          title: logoutMenuTitle,
                          iconAssetName: logoutIconAssetName,
                          onTap: (context) => onPressedLogout(context),
                          hasTopDivider: true,
                        ),
                      );
                    }
                    ...
                    return Column(
                      ...
                      children: newMainMenus.map((menu) {
                        if (menu.hasTopDivider) {
                          return Column(
                            mainAxisAlignment: MainAxisAlignment.start,
                            children: [
    ...
    return Column(
      children: [
        _AppDrawerMenuContentListTile(
          ...
          onTap: widget.menu.onTap != null
              ? () => widget.menu.onTap!(context)
          ...
          buildListTile: widget.buildListTile != null
              ? (context, child) {
                  return widget.buildListTile!(context, widget.menu, child);
                }
              : null,
        ),
        widget.menu.children.isNotEmpty
...
class _AppDrawerMenuContentListTile extends StatelessWidget {
  ...
  final Widget Function(BuildContext context, Widget child)? buildListTile;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: buildListTile != null
          ? buildListTile!(context, _buildWidget(context))
              ...
              children: [
                iconAssetName == null
                    ...
                    : ElevarmIcon(
                        ...
                        size: 24.0,
                        color:
                            isActive ? Colors.white : ElevarmColors.primary300,
                      ),
                isDrawerExpanded
                    ? Flexible(
                        child: Row(
