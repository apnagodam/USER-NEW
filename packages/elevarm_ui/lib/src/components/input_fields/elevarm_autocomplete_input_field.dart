...
@Deprecated('Use ElevarmTypeaheadInputFieldV2 instead')
class ElevarmAutocompleteInputField<T> extends StatefulWidget {
  ...
  /// Whether the option item height adapts to text length.
  /// If true, the height will grow for long text.
  final bool enableDynamicItemHeight;
  ...
  const ElevarmAutocompleteInputField({
    ...
    this.onTextChanged,
    this.enableDynamicItemHeight = false,
    super.key,
  });
...
class _ElevarmAutocompleteInputFieldState<T>
          ...
          child: Padding(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return Container(
                  height: !widget.enableDynamicItemHeight ? 48.0 : null,
  ...
  Widget _buildOption(
    ElevarmAutocompleteInputFieldOption<T> option,
  ) {
    return widget.enableDynamicItemHeight
        ? Column(
            ...
            children: [
              ...
              if (option.subtitle != null)
                Text(
                  option.subtitle!,
                  style: LibraryTextStyles.interMdRegularNeutral400,
                ),
            ],
          )
        : Row(
