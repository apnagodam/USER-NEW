...
class ElevarmDropdownInputField<T> extends StatefulWidget {
  ...
  final BoxConstraints? popUpMenuConstrains;
...
class _ElevarmDropdownInputFieldState<T>
  ...
  late final Key _widgetKey = widget.key ?? GlobalKey();
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        return ElevarmTextInputField(
          ...
          onTap: () {
            var ctx = (widget.key is GlobalKey)
                ? (_widgetKey as GlobalKey).currentContext
                : context;
            final RenderBox renderBox = ctx?.findRenderObject() as RenderBox;
            final Size size = renderBox.size;
            final Offset offset = renderBox.localToGlobal(Offset.zero);
            showMenu(
              constraints: widget.popUpMenuConstrains ?? constraints,
